                    ...
                    <main class="site-main">
                        <div class="row" style="margin: 0;">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" style="padding: 0;">
                                    ...
                                    <?php
                                        ...
                                        if( $sub_cats ){
                                            foreach( $sub_cats as $cat ){
                                                if ($cat->term_id != $cat2 && $cat->term_id != 9) {
                                                    ?>
                                                    <div class="assort-cat__item assort-cat__item-full" style="background: url(<?php echo get_field('catalog_img', $cat); ?>) center center/cover no-repeat;">
                                ...
                                <div class="container">
                                    <div class="row assort-full">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div class="assort-full__text">
                                                <p class="text-center">
                                                    <a href="<?php echo get_template_directory_uri() . '/assets/files/MENYu.pdf' ?>" download="">Скачать полное меню (.pdf)</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
